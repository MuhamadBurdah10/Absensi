      ...
      <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
        ...
        <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
          ...
          <div class="kt-container kt-grid__item kt-grid__item--fluid mb-1">
            <form action="<?= base_url('manager/rekap'); ?>" method="POST" autocomplete="off">
              <div class="row">
                <div class="col-md-3">
                  ...
                  <tbody>
                    <?php foreach ($absen as $d) :; 
                      ...
                      <tr>
                        ...
                        <td><?= $d->jam_masuk; ?></td>
                        <td><?= $d->jam_keluar; ?></td>
                        <td style="vertical-align: middle;"><img style="width: 90px;"id="myImg" src="<?= base_url().'assets/img/'.$d->image;?>" onclick="modal_image('<?= base_url().'assets/img/'.$d->image;?>');" alt="No Image" width="50px" height="70px"></td>
